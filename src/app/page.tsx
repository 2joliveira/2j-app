...
export default function Home() {
  return (
    <div className="bg-[url(/bg-projects.jpg)] bg-auto relative w-full space-y-5 p-4 overflow-hidden">
      <section className="relative ml-20 z-2 flex items-center w-fit max-w-[600px] min-h-80 bg-white p-4 gap-5 rounded-lg mt-20 shadow-[0_0_50px_rgba(59,130,246,0.3)] animate-slide-down mb-10">
