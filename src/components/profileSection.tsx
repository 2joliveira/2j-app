...
export function ProfileSection() {
  ...
  return (
    <section className={`relative md:ml-20 z-2 flex flex-col md:flex-row items-center 
    w-fit md:max-w-[600px] min-h-60 bg-white px-4 py-6 gap-5 rounded-lg md:mb-10 md:mt-20 
    shadow-[0_0_20px_rgba(59,130,246,0.3)] ${loadedImage && "animate-slide-down"}`}>
